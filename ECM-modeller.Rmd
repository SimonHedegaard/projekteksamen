...
```{r}
ECM <- dynlm(TSDELTALOG(ger_nom_ts)~L(TSDELTALOG(USA_nom_ts,1))+L(TSDELTALOG(euro_nom_ts))+L(rente_ts,6)+L(ULC_ts,3)+L(log(USA_nom_ts),1)+log(euro_nom_ts)+trend(TSDELTALOG(ger_nom_ts)))
summary(ECM)
```
