...
ggplot(debt, aes(x = date01)) +
  geom_line(aes(y = debt$`Percent of GDP...3`, color = "Tyskland"), linetype = "solid") +
  geom_line(aes(y = debt$`Percent of GDP...18`, color = "EU"), linetype = "solid") + # Tilføjelse af linje for enhedslønomkostninger
  labs(title = "",
       x = "År",
       y = "Pct. af BNP") +
