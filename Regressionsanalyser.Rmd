...
names<- c("Intercept", "Eksport", "Rente", "Unit Labour Cost", "Kina BNP vækst", "USA BNP vækst", "Eurozone BNP vækst", "Inflation", "Inflation^2")

# Pass the modified model object to screenreg()
library(texreg) # Assuming you're using the texreg package for screenreg()
screenreg(nytforsøg, custom.coef.names=names, custom.model.names="Model for BNP")
```
